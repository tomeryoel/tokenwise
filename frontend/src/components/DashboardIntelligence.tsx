...
export default function DashboardIntelligence({
  ...
  const sessionsToReview =
    summary.power.overpowered + summary.power.underpowered;
  ...
  return (
    ...
    >
      ...
      <div className="intelligence-hero">
        ...
        <div className="intelligence-kpi-grid">
          ...
          <IntelligenceKpi
            ...
            value={String(sessionsToReview)}
            detail={`${summary.power.overpowered} overpowered · ${summary.power.underpowered} underpowered`}
            tone={sessionsToReview ? "warning" : "neutral"}
          />
          <IntelligenceKpi
      ...
      <details className="intelligence-details">
        <summary>
          <span>
            <strong>Evidence and task breakdown</strong>
            <small>
              Coverage, confidence, route classification, and Model Fit by use case
            </small>
          </span>
          <span>View supporting evidence</span>
        </summary>
        <div className="intelligence-details-content">
