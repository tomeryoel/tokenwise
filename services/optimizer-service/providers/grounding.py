...
_PRODUCT_TOPIC = re.compile(
    ...
    r"model\s+fit|fit\s+gap|cost[-\s]+to[-\s]+success|"
    r"coding\s+session|verified\s+outcome|decision\s+intelligence|"
...
def build_grounded_system_prompt(
    ...
    return (
        ...
        "- Model Fit and Cost-to-Success are implemented only for Playground coding "
        "sessions with recorded outcome evidence; before verification they remain "
        "unavailable.\n"
        "- Fit Gap and overpowered/underpowered conclusions require qualified "
        "comparison evidence and must remain unavailable during cold start.\n"
        ...
        "automatic cross-tool coding analytics.\n"
